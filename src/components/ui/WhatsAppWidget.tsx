...
const WhatsAppWidget: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {isOpen && (
        <div className="bg-white rounded-xl shadow-xl p-4 mb-4 w-72 animate-fadeIn">
          <div className="flex justify-between items-center mb-3">
            <h4 className="font-semibold text-green-600">Chat with us</h4>
            <button
          ...
          <p className="text-sm text-gray-600 mb-4">
            If you have any questions, chat with our support team on WhatsApp!
          </p>
          <a
            href={whatsappUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="w-full flex items-center justify-center bg-[#25D366] hover:bg-[#128C7E] text-white font-medium py-2 px-4 rounded-lg transition-colors"
          >
            <svg
      ...
      <button
        onClick={toggleWidget}
        className={`rounded-full w-14 h-14 flex items-center justify-center shadow-lg transition-all animate-bounce ${
